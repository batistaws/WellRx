...
public class PacienteService {
    ...
    public PacienteService(PasswordEncoder passwordEncoder, UsuarioRepository usuarioRepository, PerfilRepository perfilRepository) {
    ...
    @Transactional
    public void cadastrar(@Valid CadastroPacienteDto dto) {
